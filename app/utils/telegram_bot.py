...
MINI_APP_URL = "https://shill-forge-bot-guz6.vercel.app"  # your real URL
...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    keyboard = [
        [InlineKeyboardButton("⚡ Open ShillForge", web_app=WebAppInfo(url=f"{MINI_APP_URL}{ref_param}"))],
...
async def help_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    await update.message.reply_text("🔧 *ShillForge*\n\n/start — Launch the Mini App", parse_mode="Markdown")
